...
for i=1:size(N,2)
    n = N(i);
    for rep=0:(reps - 1)                                
        filenamesD2DNoReuse(i, rep+1) = {strcat('../../results/stackelcompare_tu_noreuse/deltazero_n', int2str(n), '_rep', int2str(rep), '.sca.d2d')};   
        filenamesCellNoReuse(i, rep+1) = {strcat('../../results/stackelcompare_tu_noreuse/deltazero_n', int2str(n), '_rep', int2str(rep), '.sca.cell')};   
        
        filenamesD2DRandReuse(i, rep+1) = {strcat('../../results/stackelcompare_tu_random/deltazero_n', int2str(n), '_rep', int2str(rep), '.sca.d2d')};   
        filenamesCellRandReuse(i, rep+1) = {strcat('../../results/stackelcompare_tu_random/deltazero_n', int2str(n), '_rep', int2str(rep), '.sca.cell')};   
        
        filenamesD2DStaReuse(i, rep+1) = {strcat('../../results/stackelcompare_tu_sta/deltazero_n', int2str(n), '_rep', int2str(rep), '.sca.d2d')};   
        filenamesCellStaReuse(i, rep+1) = {strcat('../../results/stackelcompare_tu_sta/deltazero_n', int2str(n), '_rep', int2str(rep), '.sca.cell')};   
        
        filenamesD2DStaReuseTx(i, rep+1) = {strcat('../../results/stackelcompare_tu_sta_tx/deltazero_n', int2str(n), '_rep', int2str(rep), '.sca.d2d')};   
        filenamesCellStaReuseTx(i, rep+1) = {strcat('../../results/stackelcompare_tu_sta_tx/deltazero_n', int2str(n), '_rep', int2str(rep), '.sca.cell')};   
    end    
end
